...
const ThreeRateGoalsScreen = () => {
    ...
    const setRating = async (rating) => {
        ...
        ratingsToSave.goalThree.difficulty = rating;
        ...
        try {
          ...
          navigation.navigate('Begin User Profile Screen')
    }
  ...
  return (
    <SafeAreaView style = {styles.background}>
        <View style={styles.header}>
            <TouchableOpacity style = {styles.headerOne} onPress = {() => navigation.navigate('Rate Goals Screen Two')}>
          ...
          <Text style = {styles.subtitle}>Please rate how difficult you think the following goal is to complete</Text>
          <View style = {styles.GoalDivider}></View>
          <Text style = {styles.goalOne}>Communicate over the phone</Text>
...
export default ThreeRateGoalsScreen