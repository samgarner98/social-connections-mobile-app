        ...
        <View style={styles.content}>
          ...
          {person == true ? (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("Select Person Screen", {
                  goalNo: goalNo,
          ...
          {person.imageAvailable ? (
            <Image style={styles.image} source={{ uri: person.image.uri }} />
          ) : (
            <View></View>
          )}
          ...
          {journal != false ? (
            <Text style={styles.person}>Journal</Text>
          ) : (
            <Text></Text>
          )}
          {journal == true ? (
