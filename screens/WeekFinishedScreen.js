...
const WeekFinishedScreen = ({ route }) => {
  ...
  return (
    <SafeAreaView style={styles.background}>
      ...
      {goalCompletion.goalOne == true &&
      goalCompletion.goalTwo == true &&
      goalCompletion.goalThree == true ? (
        <View>
          <Text style={styles.trophyText}>
            Well Done! You earned a {userInterest} by completing all the goals
          </Text>
          {userInterest == "flower" ? (
            <Lottie
          ...
          {progress > 0 ? (
            <Text style={styles.trophyText}>
              You also performed better than expected. You have made great
              progress!
            </Text>
          ) : (
            <Text></Text>
          ...
          {progress == 0 ? (
            <Text style={styles.trophyText}>
              You performed very well and completed the goals as expected. Keep
              up the great work!
            </Text>
          ) : (
            <Text></Text>
          ...
          {progress < 0 ? (
            <Text style={styles.trophyText}>
              You found the goals challenging but still managed to complete them
              all. Brilliant work, keep it up!
            </Text>
          ) : (
            <Text></Text>
          )}
      ...
      {completion == 2 ? (
        <View>
          <Text style={styles.trophyText}>
            Well Done! You came close to earning a trophy as you completed two
            of the goals. You can do it next week!
          </Text>
          {progress > 0 ? (
            <Text style={styles.trophyText}>
              You also performed better than expected with the goals you
              achieved. You have made great progress!
            </Text>
          ) : (
            <Text></Text>
          )}
          ...
          {progress < 0 ? (
            <Text style={styles.trophyText}>
              You found the goals challenging but still managed to complete most
              of them. Brilliat work, keep it up!
            </Text>
          ) : (
            <Text></Text>
          )}
      ...
      {completion == 1 ? (
        <View>
          <Text style={styles.trophyText}>
            One step at a time! You did well and managed to complete one of the
            goals. Lets aim for more next week
          </Text>
          {progress > 0 ? (
            <Text style={styles.trophyText}>
              You also performed better than expected with the goal you
              achieved. You have made progress!
            </Text>
          ) : (
            <Text></Text>
          )}
          {progress == 0 ? (
            <Text style={styles.trophyText}>
              You completed the goal as expected. Keep up the great work!
            </Text>
          ) : (
            <Text></Text>
          )}
          {progress < 0 ? (
            <Text style={styles.trophyText}>
              You found the goal challenging but still managed to complete it.
              Good job!
            </Text>
          ) : (
            <Text></Text>
      ...
      {completion == 0 ? (
        <View>
          <Text style={styles.trophyText}>
            {" "}
            No worries. You didnt manage to complete any of the goals but we can
            try again next week!
          </Text>
        </View>
      ) : (
