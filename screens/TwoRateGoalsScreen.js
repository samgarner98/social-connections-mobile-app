...
const TwoRateGoalsScreen = () => {
    ...
    const setRating = async (rating) => {
        ...
        ratingsToSave.goalOne.difficulty = rating;
        ...
        try {
          ...
          navigation.navigate('Rate Goals Screen Three')
    }
  ...
  return (
    <SafeAreaView style = {styles.background}>
        <View style={styles.header}>
            <TouchableOpacity style = {styles.headerOne} onPress = {() => navigation.navigate('Rate Goals Screen')}>
          ...
          <Text style = {styles.goalOne}>Use Public Transport</Text>
...
export default TwoRateGoalsScreen