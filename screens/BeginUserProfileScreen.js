...
const BeginUserProfileScreen = () => {
  ...
  return (
    <SafeAreaView style = {styles.background}>
        ...
        <Text style = {styles.title}>Nearly There!</Text>
        <Text style = {styles.titleTwo}>Thank you for answering the questions. </Text>
        <Text style = {styles.titleTwo}> All that's left for you to do, is set up your About Me page.</Text>
...
export default BeginUserProfileScreen