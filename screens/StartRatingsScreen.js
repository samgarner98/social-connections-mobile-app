...
const StartRatingsScreen = () => {
  ...
  return (
    <SafeAreaView style = {styles.background}>
        ...
        <Text style = {styles.titleTwo}>Now lets rate how hard you find some tasks.</Text>
        <Text style = {styles.titleTwo}>This is to make sure your weekly goals are suitable for you.</Text>
...
export default StartRatingsScreen