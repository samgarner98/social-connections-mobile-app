...
const HelpScreen = () => {
  ...
  return (
    <SafeAreaView style = {styles.background}>
      ...
      {emergencyContact != ' ' ? <TouchableOpacity style = {styles.EmergencyContact} onPress = {() => navigation.navigate("View Contact", {contact: emergencyContact })}>
            <Text style = {styles.infoDisplaytwo}>{emergencyContact.firstName} {emergencyContact.lastName}</Text> 
            </TouchableOpacity>
...
<TouchableOpacity style = {styles.EmergencyContact} onPress = {() => Linking.openURL('tel:+999')}>
