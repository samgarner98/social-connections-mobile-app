...
const GoalDifficulty = ({route}) => {
    ...
    const setRating = async (rating) => {
        ...
        try {
            await AsyncStorage.setItem('@NewGoalRatings', JSON.stringify(ratingsToSave))
          } catch (e) {
            console.log(e)
            // saving error
          }
  ...
  return (
    <SafeAreaView style = {styles.background}>
          ...
          <Text style = {styles.subtitle}>Please rate how difficult it was to complete the goal </Text>
