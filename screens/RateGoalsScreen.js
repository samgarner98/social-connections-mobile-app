...
const RateGoalsScreen = () => {
    ...
    const info = {
       goalOne : {name: "Meet with a friend for lunch",
        physical: true,
        difficulty: 3,
        location: true,
        person: true,
        journal: false},
        goalTwo: {name: "Go for a walk at a local park",
                physical: true,
                difficulty: 3,
                location: true,
                person: false,
                journal: false},
                goalThree: {name: "Have a phone call with a loved one",
                        physical: false,
                        difficulty: 3,
                        location: false,
                        person: true,
                        journal: false},
                        goalFour: {name: "Invite a friend over for dinner",
                                physical: false,
                                difficulty: 3,
                                location: false,
                                person: true,
                                journal: false},
                                goalFive: {name: "Write a Journal Entry about something you did this week",
                                        physical: false,
                                        difficulty: 3,
                                        location: false,
                                        person: false,
                                        journal: true},
                                        goalSix: {name: "Go for a walk",
                                                physical: true,
                                                difficulty: 3,
                                                location: true,
                                                person: false,
                                                journal: false},
                                                goalSeven: {name: "Text a friend to arrange a meet up",
                                                        physical: false,
                                                        difficulty: 3,
                                                        location: true,
                                                        person: true,
  ...
  return (
    <SafeAreaView style = {styles.background}>
          ...
          <Text style = {styles.subtitle}>Rate how difficult the following task is</Text>
