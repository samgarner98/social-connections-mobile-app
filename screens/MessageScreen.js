...
import { View, Text, TextInput, Button, StyleSheet, SafeAreaView, Alert, Platform, StatusBar, Image, TouchableOpacity, KeyboardAvoidingView, Keyboard} from 'react-native'
...
const MessageScreen = ({route}) => {
    ...
    useLayoutEffect(() => {
      ...
      const chooseMessage = () => {
        ...
        const body = {goalOne: "are you available to meet for lunch sometime this week?",
    goalThree: "would you like to have a catch-up over the phone this week? Let me know what time suits you",
