...
import { Dimensions, View, StyleSheet, TextInput, Touchable, TouchableOpacity, Text, SafeAreaView, ScrollView, Checkbox} from 'react-native';
...
const MapDisplayScreen = ({route}) => {
    ...
    const GOOGLE_API_KEY = 'AIzaSyD85mtgaRF3QYxdniTj-6NrIjOeLQIR_rE';
      ...
      const destination = {latitude: 55.8724, longitude: 4.2900};
      const destinationTwo = {latitude: 55.86947634821373, longitude: -4.3003211729268545};
