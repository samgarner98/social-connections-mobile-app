...
export default function App() {
  return (
    ...
    <Stack.Navigator>
        ...
        <Stack.Screen name="Rate Goals Screen Two" component={TwoRateGoalsScreen} />
        <Stack.Screen name="Rate Goals Screen Three" component={ThreeRateGoalsScreen} />
        <Stack.Screen name="View Goal Screen" component={ViewGoalScreen} />
        <Stack.Screen name="Select Person Screen" component={GoalPerson} />
        <Stack.Screen name="Goal Complete Screen" component={GoalCompleteScreen} />
        <Stack.Screen name="Goal Difficulty" component={GoalDifficulty}/>
        <Stack.Screen name="Trophy Complete" component={TrophyComplete} />
        <Stack.Screen name="All Goals Complete Screen" component={AllGoalsCompleteScreen} />
        <Stack.Screen name="Navigation Steps Screen" component={NavigationSteps} />
        ...
        <Stack.Screen name="Week Finished Screen" component={WeekFinishedScreen}/>
        <Stack.Screen name="Getting Started" component={GettingStarted}/>
        <Stack.Screen name="User Interest Screen" component={UserInterest}/>
        <Stack.Screen name="Interest Complete Screen" component={InterestCompleteScreen}/>
        <Stack.Screen name="Start Ratings Screen" component={StartRatingsScreen}/>
        <Stack.Screen name="Begin User Profile Screen" component={BeginUserProfileScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
